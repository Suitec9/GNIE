...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>GNIE</title>
        <meta name="description" content="Connectlist-Dapp" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to the ANIMATION NFT summit!</h1>
          <div className={styles.description}>
        ...
        <div>
          <img className={styles.image} src="./GNIE/0.svg" />
        </div>
      </div>
